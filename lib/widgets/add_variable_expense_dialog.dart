...
class AddVariableExpenseDialog extends StatefulWidget {
  ...
  @override
  State<AddVariableExpenseDialog> createState() =>
      _AddVariableExpenseDialogState();
}

class _AddVariableExpenseDialogState extends State<AddVariableExpenseDialog> {
    ...
    return Column(
      ...
      children: [
        ...
        TextField(
          ...
          style: const TextStyle(color: Color(0xFFF1F5F9)),
          decoration: InputDecoration(
            hintText: 'Ej: Compras, Fast Food, Transporte...',
            hintStyle: const TextStyle(color: Color(0xFF64748B)),
            prefixIcon: const Icon(
